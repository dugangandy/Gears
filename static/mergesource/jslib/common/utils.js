 ...
 * @param url2
 */
FormUtil.initTwoCombobox = function(id1,id2,url1,url2){
    //一级分类
    var provinceId = $('#' + id1).combobox({
        width:150,
        panelHeight:150,
    ...
    if(provinceId.val() == null || provinceId.val() ==undefined || provinceId.val() == 0){
    	provinceId.combobox('selectedIndex', 0);
    }
    //二级分类
    var cityId = $('#'+ id2).combobox({
    ...
    if(cityId.val() == null || cityId.val() ==undefined|| cityId.val() == 0){
    	cityId.combobox('selectedIndex', 0);
    }
}
